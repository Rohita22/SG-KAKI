...
export const STATION_STAGES: Record<StationStageId, StationStageConfig> = {
  ...
  'punggol-nel-escalator': { background: 'scene4-punggol-nel-escalator', image: 'punggol-nel-escalator.png', context: 'punggol-escalator', map: 'scene4-punggol-nel-escalator-map', spawnX: 450, portalX: 1270 },
  'little-india-nel-arrival': { background: 'scene4-little-india-nel-arrival', image: 'little-india-nel-platform.png', context: 'little-india-alight', map: 'scene4-little-india-nel-arrival-map', spawnX: 520, portalX: 1660 },
